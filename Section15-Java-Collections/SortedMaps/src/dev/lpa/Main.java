...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<LocalDate, List<Purchase>>  week1Puchases = datedPurchases.headMap(week1);
        Map<LocalDate, List<Purchase>> week2Purchases = datedPurchases.tailMap(week1);

        /*System.out.println("--".repeat(60));
        week1Puchases.forEach((key, value) -> System.out.println(key + ": " + value));
        System.out.println("--".repeat(60));
        week2Purchases.forEach((key, value) -> System.out.println(key + ": " + value));
        System.out.println("--".repeat(60));*/

        displayStats(1, week1Puchases);
    ...
    private  static  void addPurchase(String name, Course course, double price) {
        ...
        int day = new Random().nextInt(1, 15);//purchases.size() + 1;
