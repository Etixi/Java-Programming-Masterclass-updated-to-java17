...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Card> acesOfHearst = Collections.nCopies(13, aceOfHearts);
        Card.printDeck(acesOfHearst, "Aces of Hearts", 1);
        ...
        if (Collections.replaceAll(deck, tenOfHearts, tenOfClubs)) {
            ...
            System.out.println("No tems of hearts found in the list");
        }
