...
public class Main {
    public static void main(String[] args) {
        ...
        String htmlSnippet = """
                ...
                <p>This is a another paragraph about something else.</p>
                <h3>Summary</h3>
                """;

        Pattern htmlPattern = Pattern.compile("<[hH](?<level>\\d)>(.*)</[hH]\\d>"); // "<[hH](\\d)>(.*)</[hH]\\d>")
        ...
        );// htmlMatcher.replaceFirst("First Header");
