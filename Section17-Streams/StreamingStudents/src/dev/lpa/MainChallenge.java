...
public class MainChallenge {
    public static void main(String[] args) {
       ...
       /* List<Student> students = Stream
        ...
        Comparator<Student> longTermStudent = Comparator.comparingLong(Student::getAgeEnrolled);
        ...
        List<Student> hardWorkers = students.stream()
                ...
                .limit(10)
                .toList();
        System.out.println("harWorkers = " + hardWorkers.size());
        ...
        Comparator<Student> uniqueSorted = Comparator.comparingLong(Student::getStudentId);
