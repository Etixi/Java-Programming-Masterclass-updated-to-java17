...
public class Student {
    ...
    private final boolean programingExperience;
    ...
    public Student(String countryCode, int yearEnrolled, int ageEnrolled, String gender,
                   boolean programingExperience, Course... courses) {
        studentId = lastStudentId++;
        this.countryCode = countryCode;
        this.yearEnrolled = yearEnrolled;
        this.ageEnrolled = ageEnrolled;
        this.gender = gender;
        this.programingExperience = programingExperience;
    ...
    public boolean hasProgramingExperience() {
        return programingExperience;
    }
    ...
    public static Course[] getRandomSelection(Course... courses) {

        int courseCount = random.nextInt(1, courses.length + 1);
        List<Course> courseList = new ArrayList<>(Arrays.asList(courses));
        Collections.shuffle(courseList);
        List<Course> selectedCouses = courseList.subList(0, courseCount);
        return selectedCouses.toArray(new Course[0]);
    }
    ...
    public String toString() {
        return "Student{" +
                ...
                ", gender='" + gender + '\'' +
                ", programingExperience=" + programingExperience +
