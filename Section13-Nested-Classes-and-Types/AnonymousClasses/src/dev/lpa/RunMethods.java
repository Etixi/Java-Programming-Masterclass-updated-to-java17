...
public class RunMethods {
    public static void main(String[] args) {
        ...
        sortId(storeEmployees, c0);
        sortId(storeEmployees, c1);
        sortId(storeEmployees, c2);
        sortId(storeEmployees, c3);
        sortId(storeEmployees, c4);
        sortId(storeEmployees, (o1, o2) -> o1.getName().compareTo(o2.getName()));
        sortId(storeEmployees, new Comparator<StoreEmployee>() {
            @Override
            public int compare(StoreEmployee o1, StoreEmployee o2) {
                return o1.getName().compareTo(o2.getName());
            }
    ...
    public static <T> void sortId(List<T> list,
