...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        calculator(Double::sum, 10.56, 25.6);
        ...
        BinaryOperator<String> b1 = String::concat; // (s1, s2) -> s1.concat(s2);
        BiFunction<String, String, String> b2 = String::concat; // (s1, s2) -> s1.concat(s2);
