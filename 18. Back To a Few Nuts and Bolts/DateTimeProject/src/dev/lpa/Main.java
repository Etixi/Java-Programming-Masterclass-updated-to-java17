...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("today == now ? " + May5.compareTo(LocalDate.now()));
        System.out.println("today == now ? " + May5.equals(LocalDate.now()));
        ...
        May5.datesUntil(May5.plusDays(1))
                .forEach(System.out::println);
        May5.datesUntil(May5.plusDays(1), Period.ofDays(7))
                .forEach(System.out::println);
        ...
        LocalTime sevenPM = LocalTime.parse("19:30");
