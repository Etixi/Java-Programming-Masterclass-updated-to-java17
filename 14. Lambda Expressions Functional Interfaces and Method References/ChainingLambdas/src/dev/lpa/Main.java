...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String,String> lastName = s -> s.concat("Etienne");
        ...
        Predicate<String> p1 = s -> s.equals("Koa");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Koa");
