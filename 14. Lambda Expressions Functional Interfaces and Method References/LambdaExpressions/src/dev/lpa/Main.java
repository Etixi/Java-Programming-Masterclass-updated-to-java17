...
public class Main {
    public static void main(String[] args) {
        ...
        int resultForm1 = calculator(( a, b) -> a + b, 5, 2);
        int resultForm2 = calculator((Integer a, Integer b) -> a + b, 5, 2);
        int resultForm3 = calculator((var a, var b) -> a + b, 5, 2);
        int resultForm4 = calculator((var a, var b) -> {return a + b;}, 5, 2);
    ...
    */
    ...
    public static String[] randomSelectedValues(
            int count,
            String[] values,
            Supplier<Integer> s
    ) {
